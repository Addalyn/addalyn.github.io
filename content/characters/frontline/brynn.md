...
- **Cooldown:** None
- **Free:** No
- **Description:** Stab with your spear, dealing **28** direct damage. Each target hit takes **5** less damage than the previous.
...
| Hold the Line          | Each target hit grants **5** shielding when **Aegis** is activated. Stacks with multiple stabs, up to a max of **20**. | 2        | Shield Up |
| Reinforced Spear       | Gain **2** extra energy per target hit.                                                                                | 2        | Energy    |
| Radamantium Reinforced | The first target hit takes an additional **2** damage.                                                                 | 3        | Damage Up |
| Tip Of Justice         | Enemies on the tip of the spear take **4** extra damage.                                                               | 2        | Damage Up |
...
- **Cooldown:** 2
- **Free:** Yes
- **Description:** Gain **Cover** in a direction for **1** turn, reducing damage from attacks.
...
| Skybranium Alloy  | Gain **2** extra damage on your next **Soaring Shield** each time you block. Stacks with multiple blocks up to a max of **10** extra damage. | 2        | Damage Up |
| Shieldbearer      | The cover persists for **1** extra turn.                                                                                                     | 3        | Duration  |
...
- **Cooldown:** 3
- **Free:** No
- **Description:** Throw your shield, dealing **28** direct damage to the first enemy hit, and **Knocking Back** them. This attack can bounce off walls.
...
| Wind Up             | Increase the maximum number of bounces by **1** and gain **2** extra damage per bounce.                       | 2        | Range Up        |
| Press the Advantage | Gain **Might** next turn.                                                                                     | 3        | Good Status     |
| Ricoshield          | Shield bounces off the first enemy. Deal **16** damage to the second target hit.                              | 3        | Target Increase |
| Boomerang           | The shield continues after hitting a target. If you bounce it back to yourself, reduce the cooldown by **1**. | 2        | Cooldown        |
...
- **Cooldown:** 5
- **Free:** No
- **Description:** Dash to a location and unleash a cone attack, dealing **26** direct damage to enemies and inflicting **Weak** until end of turn. **Aegis** is activated automatically in the direction of your attack.
...
| Safeguard       | When **Aegis** is triggered by this ability it persists for **2** turns.           | 2        | Duration    |
| Warden          | If you are hit on the turn you use this ability, the cooldown is reduced by **2**. | 3        | Cooldown    |

**Default Mod:** Booster Boots
